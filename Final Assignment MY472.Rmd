...
1) In this case, we are not using the mean popularity to avoid an endogeneity problem. 
2) Even though there is an outlier, the correlation would still be positive is we omitted it.
...
In summary, the analysis uncovers that factors such as prolific album production, lyrical themes, and chosen music genre significantly impact the enduring quality of an artist's music. These insights contribute to a better understanding of the evolving nature of music over time. However, it is essential to emphasize the importance of embracing diverse genres and global expressions, opening up to music from the whole world.
